...
<div class="p-2">
    <div class="row mb-4">
        <div class="col-md-6">
            ...
            <span class="badge-xs badg p-2 px-3 rounded bg-{{\App\Models\Project::$status_color[$milestone->status]}}">{{ __(\App\Models\Project::$project_status[$milestone->status]) }}</span>
        </div>
